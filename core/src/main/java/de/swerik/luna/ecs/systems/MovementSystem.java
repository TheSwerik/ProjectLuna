...
public class MovementSystem extends EntitySystem {
    ...
    public MovementSystem(Luna app) {
        this.app = app;
    }

    public void addedToEngine(Engine engine) {
        if (engine != null) {
            entities = engine.getEntitiesFor(Family.all(PositionComponent.class, VelocityComponent.class, MomentumComponent.class, EntityStateComponent.class, BodyComponent.class).get());
        } else {
