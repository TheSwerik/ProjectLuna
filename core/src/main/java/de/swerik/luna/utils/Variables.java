...
public class Variables {
    ...
    public static final short FRIENDLY_RIGHT_SENSOR         = 0x0040;
    public static final short FRIENDLY_RIGHT_UPPER_SENSOR   = 0x0080;

    public static final short FRIENDLY_LEFT_SENSOR          = 0x0100;
    public static final short FRIENDLY_LEFT_UPPER_SENSOR    = 0x0200;
    public static final short FRIENDLY_RIGHT_WALL_SENSOR    = 0x0400;
    public static final short FRIENDLY_LEFT_WALL_SENSOR     = 0x0800;
